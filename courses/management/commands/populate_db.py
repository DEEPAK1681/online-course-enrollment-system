...
from courses.models import User, Course, Module, Enrollment
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        instructors_data = [
            {'name': 'Saransh', 'email': 'saransh@gmail.com'},
            {'name': 'Shubham', 'email': 'shubham@gmail.com'},
        ]

        students_data = [
            {'name': 'Nikhil', 'email': 'nikhil@gmail.com'},
            {'name': 'Raghav Garg', 'email': 'raghavgarg@gmail.com'},
            {'name': 'Lakhvinder', 'email': 'lakhvinder@gmail.com'},
            {'name': 'Deepak Garg', 'email': 'deepakgarg@gmail.com'},
        ]
